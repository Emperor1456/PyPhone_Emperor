# 📘 Module 08 – OOP for ORMs · Revision Guide
...
- Instance variable shadows class variable if the same name is used.
...
**Quick Test:**  
- What is the purpose of `self` in instance methods?  
- How do you call a parent class method from a child class?  
- What is the difference between a class variable and an instance variable?  
- When would you use `@property` instead of a regular method?

*Review complete. You are now ready for the Module 08 Practice Review.*