# 📘 Module 09 – Modern Python & Tools · Revision Guide
...
**Quick Test:**  
- How do you install all dependencies from a `requirements.txt` file?  
- What is the difference between a list comprehension and a generator expression?  
- Why must you `await` an async function instead of calling it directly?  
- How do decorators add behavior without modifying the original function?

*Review complete. You are now ready for the Module 09 Practice Review.*