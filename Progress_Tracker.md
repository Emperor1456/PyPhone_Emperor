...
**Instructions:** Replace `⬜` with `✅` when you complete a lesson.

---

## Module 1 – Python Core
| L# | Topic | Lecture | Practice | Debug | Done |
|----|-------|:-------:|:--------:|:-----:|:----:|
...
| L29 | LEGB Rule – Local, Enclosing, Global, Built‑in | ⬜ | ⬜ | ⬜ | ⬜ |
...
*Check off each brick. Your empire grows one lesson at a time.*